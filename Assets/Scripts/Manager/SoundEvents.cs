...
public class SoundEvents
{
    ...
    //already : Il y a déjà un son codé dans le asset, donc pas nécessaire de faire un nouveau son ou un son par dessus

    //Player
    public static Action onPlayerJump; //Emileb //Asset  //Alex
    ...
    //Interaction
    public static Action onCollideLevelExit; //Emile //already
